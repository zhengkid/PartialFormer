...
from fairseq.data import (
    ...
    LanguagePairDataset,
    GatLanguagePairDataset,
)

from . import FairseqTask, register_task


@register_task('gat_translation')
class GatTranslationTask(FairseqTask):
    """
    ...
    def load_dataset(self, split, combine=False, **kwargs):
        ...
        if len(src_datasets) == 1:
            src_dataset, tgt_dataset, tree_dataset = src_datasets[0], tgt_datasets[0], tree_datasets[0]
        else:
            print(1)
        ...
        self.datasets[split] = GatLanguagePairDataset(
    ...
    def build_dataset_for_inference(self, src_tokens, src_lengths, tree):
        return GatLanguagePairDataset(src_tokens, src_lengths, self.source_dictionary, tree)
