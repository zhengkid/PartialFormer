...
@register_task('dp_tree_phrase_translation')
class DPTreePhraseTranslationTask(FairseqTask):
    """
    ...
    def load_dataset(self, split, combine=False, **kwargs):
        ...
        self.datasets[split] = DPTreePhraseLanguagePairDataset(
    ...
    def build_dataset_for_inference(self, src_tokens, src_lengths, tree, phrase):
        return DPTreePhraseLanguagePairDataset(src_tokens, src_lengths, self.source_dictionary, tree, phrase)
