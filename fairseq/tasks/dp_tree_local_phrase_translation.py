...
@register_task('dp_tree_local_phrase_translation')
class DPTreeLocalPhraseTranslationTask(FairseqTask):
    """
    ...
    def load_dataset(self, split, combine=False, **kwargs):
        ...
        self.datasets[split] = DPTreeLocalPhraseLanguagePairDataset(
    ...
    def build_dataset_for_inference(self, src_tokens, src_lengths, tree, phrase):
        return DPTreeLocalPhraseLanguagePairDataset(src_tokens, src_lengths, self.source_dictionary, tree, phrase)
