...
class ScaleRelativeMultiheadAttention(nn.Module):
    ...
    def __init__(
        ...
        self.scale_head = Parameter(torch.Tensor(1, num_heads, 1, 1))
        torch.nn.init.constant_(self.scale_head, 1.0)
    ...
    def forward(
        ...
        if saved_state is not None:
            ...
            key_padding_mask = ScaleRelativeMultiheadAttention._append_prev_key_padding_mask(
        ...
        self.scale_head_ = self.scale_head.repeat(bsz, 1, 1, 1)
        self.scale_head_ = self.scale_head_.view(bsz * self.num_heads, 1, 1)
        self.scale_head_ = self.scale_head_.repeat(1, tgt_len, 1)
        attn = attn.mul(self.scale_head_)
