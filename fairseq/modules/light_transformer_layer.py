...
from fairseq.modules import LayerNorm, EfficientPAQKMultiheadAttentionWOPGFFNs, AFFNBlock, RelativeAFFNBlock, MultiheadAttention, UniversalRelativeDynamicGraphStructureGeneration, UniversalStandardDynamicGraphStructureGeneration, \
    UniversalDynamicGraphStructureGeneration, EfficientPAQKMultiheadAttention
    ...
    *args.decoder_normalize_before* to ``True``.
    ...
    def build_self_attention(
        ...
        if args.max_relative_length == -1:
            ...
            args.max_relative_length, dropout=args.attention_dropout, k_only=args.k_only,decoder=True
        )
