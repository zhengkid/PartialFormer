...
@register_model("uniformer")
class UniformerModel(FairseqEncoderDecoderModel):
    """
    ...
    def build_model(cls, args, task):
        ...
        encoder = UniformerEncoder(args, src_dict, encoder_embed_tokens)
        decoder = UniformerDecoder(args, tgt_dict, decoder_embed_tokens)
        return UniformerModel(encoder, decoder)


class UniformerEncoder(FairseqEncoder):
    """
...
class UniformerDecoder(FairseqIncrementalDecoder):
    """
...
class UniformerEncoderLayer(nn.Module):
    """Encoder layer block.
...
class UniformerDecoderLayer(nn.Module):
    """Decoder layer block.
...
@register_model_architecture("uniformer", "uniformer")
def base_architecture(args):
    ...
    args.encoder_kernel_size_list = getattr(
        args, "encoder_kernel_size_list", [3, 3, 3, 3, 3, 3, 3, 7, 7, 7, 7, 7, 7, 7, 15, 15, 15, 15, 15, 15, 15, 31, 31, 31, 31, 31, 31, 31, 63, 63, 63, 63, 63, 63, 63]
    )
...
@register_model_architecture("uniformer", "uniformer_iwslt_de_en")
def uniformer_iwslt_de_en(args):
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 512)
...
@register_model_architecture("uniformer", "uniformer_t2t_wmt_en_de")
def uniformer_t2t_wmt_en_de(args):
...
@register_model_architecture("uniformer", "uniformer_wmt_en_de_big")
def uniformer_wmt_en_de_big(args):
    args.attention_dropout = getattr(args, "attention_dropout", 0.1)
...
@register_model_architecture("uniformer", "uniformer_wmt_en_fr_big")
def uniformer_wmt_en_fr_big(args):
    args.dropout = getattr(args, "dropout", 0.1)
    uniformer_wmt_en_de_big(args)


@register_model_architecture("uniformer", "uniformer_wmt_zh_en_big")
def uniformer_wmt_zh_en_big(args):
