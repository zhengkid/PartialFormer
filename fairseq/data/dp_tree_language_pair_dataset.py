...
def collate(
    ...
    tree = merge('tree', left_pad=left_pad_source,
        pad_to_length=pad_to_length["source"] if pad_to_length is not None else None,)
    ...
    tree:torch.Tensor = tree.index_select(0, sort_order)
...
class DPTreeLanguagePairDataset(FairseqDataset):
    """
    ...
    def filter_indices_by_size(self, indices, max_sizes):
        ...
        """
        return data_utils.filter_paired_tree_dataset_indices_by_size(
            self.src_sizes,
            self.tgt_sizes,
            self.tree_sizes,
            indices,
