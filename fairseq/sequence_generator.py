...
from fairseq.models.fairseq_encoder import MultiEncoderOut
...
class EnsembleModel(nn.Module):
    ...
    def forward_decoder(
        self,
        tokens,
        encoder_outs: List[MultiEncoderOut],
        incremental_states: List[Dict[str, Dict[str, Optional[Tensor]]]],
        temperature: float = 1.0,
    ):
        log_probs = []
        avg_attn: Optional[Tensor] = None
        encoder_out: Optional[MultiEncoderOut] = None
    ...
    @torch.jit.export
    def reorder_encoder_out(self, encoder_outs: Optional[List[MultiEncoderOut]], new_order):
        """
